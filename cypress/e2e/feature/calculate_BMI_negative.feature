@negative
Feature: BMI Calculator Negative Scenarios

  Background:
    Given I visit the BMI calculator page

  Scenario Outline: BMI calculation with invalid input
    ...
    Examples:
      ...
      | -180   | -75    | -25 | Male   | Moderate Exercise, sports 3 - 5 days/ week  | Please provide    |
      | -165   | -55    | -28 | Female | Light exercise/ sports 1 - 3 days/ week     | Please provide    |
